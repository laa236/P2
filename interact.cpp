...
void compute_density(sim_state_t* s, sim_param_t* params)
{
    ...
    #pragma omp parallel
    {
        particle_t* local_p = s->part; // Each thread gets its own view of the particle array

        for(int i=0;i<n;++i){
            particle_t *pi = local_p + i;
...
void compute_accel(sim_state_t* state, sim_param_t* params)
{
    ...
    #pragma omp parallel
    {
        particle_t* local_p = state->part; // Each thread gets its own view of the particle array
